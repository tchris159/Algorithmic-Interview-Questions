...
Assumptions: It is guaranteed that no two events on the same day intersect in time, and in_time < out_time.
...
SELECT 
    ...
    #gets difference row by row, stores in new col then aggregates 
FROM 
    employees
